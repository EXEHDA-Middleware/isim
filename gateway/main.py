...
#          Adenauer Yamin
#          Fernanda Mota
# Last editing: 2024-04-19 - 20:44 h
# ######################################## 
...
def mqtt_publication():
    ...
    try:
        client_g = MQTTClient(mqtt_client_id, mqtt_server, user='middleware', password='exehda')
        client_g.connect()
        green.value(1)
...
def sensor_read_simulated():
  ...
  if aht25_sensor.is_ready:
      ...
      stack_pub("publication", "0c0a40d1-5a15-4f26-b85f-25868dfff6ee", "exehda-pub", valor_umidade_aht25)
      stack_pub("publication", "aaa6b88b-73fe-425f-9db9-ae3a27b2401f", "exehda-pub", valor_temperatura_aht25)
